...
public class SplashImageSlider extends AppCompatActivity {
  ...
  //this Images indicator added by Gaurav only display 1 page with terms and condition.
  private static final Integer[] IMAGES= {R.drawable.screen1,R.drawable.screenslider};
...
//                    finish();
    ...
    private void init() {
     ...
     //   indicator.setRadius(5 * density);
       ...
       /* indicator.setFillColor(ContextCompat.getColor(getContext(), R.color.white));
       // indicator.setPageColor(ContextCompat.getColor(getContext(), R.color.white));
        indicator.setRadius((int) (4 * Resources.getSystem().getDisplayMetrics().density));
...
*/
        ...
        */
        ...
        indicator.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                //this condition for last page which displayed terms&condition
                if (currentPage == 1)  {
                    tv_term.setVisibility(View.VISIBLE);
                    indicator.setVisibility(View.GONE);
                    tv_exit.setVisibility(View.VISIBLE);
    ...
    public void popup(){
        ...
        webview.loadData(readFilefromPath(R.raw.termscondition_new),"text/html","utf-8");
        dialog.show();
    }
