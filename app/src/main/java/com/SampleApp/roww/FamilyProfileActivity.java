 ...
 */
public class FamilyProfileActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.family_profile_activity);
    ...
    public void loadProfile() {
        try {
            ...
            list = model.getFamilyProfilesInfo(Long.parseLong(memberProfileId));
...
//
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                ...
                if (options[item].equals("Take Photo")) {
                    ...
                    flag = "profilePic";
                    Crop.pickImage(FamilyProfileActivity.this);
    ...
    public class RemoveFamilyPhotoService extends AsyncTask<String, Object, Object> {
        ...
        String val = null;
        final ProgressDialog progressDialog = new ProgressDialog(FamilyProfileActivity.this, R.style.TBProgressBar);
