...
public class AnniversaryFragment extends Fragment {
    ...
    Calendar calendar;
    String selectedDate,celebrationType,catID;
...
//                        String number=object.getString("ContactNumber");
                        data.setContactNumber(object.getString("ContactNumber"));
...
//                        }else
                ...
                if(dataArrayList.size()>0){
                    ...
                    txt_date.setText("Today's Anniversaries");
...
//                        }else
                        ...
                        ll_whatsapp.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                ...
                                if(Utils.appInstalledOrNot(getActivity())){
                                    String url = "https://api.whatsapp.com/send?phone="+data.getContactNumber();//"https://wa.me/"+profileData.getMobile()+"/?text=hii";
                                    Intent i = new Intent(Intent.ACTION_VIEW);
                                    i.setData(Uri.parse(url));
                                    startActivity(i);
                                }
                                else   if(Utils.whatsBusinessAppInstalledOrNot(getActivity())){
                                    String url = "https://api.whatsapp.com/send?phone="+data.getContactNumber();//"https://wa.me/"+profileData.getMobile()+"/?text=hii";
                                    Intent i = new Intent(Intent.ACTION_VIEW);
                                    i.setData(Uri.parse(url));
                                    startActivity(i);
                                    ...
                                    Utils.showToastWithTitleAndContext(getActivity(),"WhatsApp is not installed");
                                }
                            }
                        });
...
//                CalendarEventsAdapter adapter = new CalendarEventsAdapter(getActivity().getApplicationContext(),eventList,celebrationType);
    ...
    public void setUserVisibleHint(boolean isVisibleToUser) {
        ...
        Utils.log("Inuser "+isVisibleToUser);
