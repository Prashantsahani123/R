...
public class Announcement extends Activity {
    ...
    private void actionbarfunction() {
        ...
        //grpID is -1 then call it from Rotary India admin module where only view the data
        //rotaryindiaadmin is added by Gaurav for RI_Admin
        if (PreferenceManager.getPreference(context, isRIadminModule).equals("Yes")) {
        ...
        spinner_filter_type.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (spinner_filter_type.getSelectedItem().toString().equals("All")) {
                    type_filter_flag = "0";
                } else if (spinner_filter_type.getSelectedItem().toString().equals("Published") ||PreferenceManager.getPreference(context, isRIadminModule).equals("Yes")) {
                    type_filter_flag = "1";
                ...
                if (InternetConnection.checkConnection(getApplicationContext())) {
                    ...
                    //Here We called the Rotary India Admin annoucement Module
                } else {
                    Utils.showToastWithTitleAndContext(getApplicationContext(), "No Internet Connection!");
                    // Not Available...
                }
...
//       {"memberProfileId":"1","groupId":"1","searchText":"","type":"1","isAdmin":"0"}
        ...
        if (PreferenceManager.getPreference(context, isRIadminModule).equals("Yes")) {
           ...
           // type_filter_flag="1";
            ...
            Log.d("Response", "PARAMETERS " + Constant.RotaryIndiaAnnouncementlist + " :- " + arrayList.toString());
            new WebConnectionAsyncAnnouncement(Constant.RotaryIndiaAnnouncementlist, arrayList, Announcement.this).execute();
        } else {
