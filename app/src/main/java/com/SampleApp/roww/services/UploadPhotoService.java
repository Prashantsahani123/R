...
//                }
    ...
    public class UploadPhotoAsyncTask extends AsyncTask<String,Object,Object>{
        ...
        protected Object doInBackground(String... params) {
            ...
            if(!path.isEmpty()){
                ...
                try {
                    val = HttpConnection.postData(url, new ArrayList<NameValuePair>());
                    Log.d("Response", "we image upload" + val);
                } catch (Exception e) {
                    e.printStackTrace();
                }
        ...
        protected void onPostExecute(Object result) {
            ...
            Utils.log("image upload result :- "+result.toString());
    ...
    public  String UploadPhotoToServer(File file_path, String url) {
        ...
        Log.d("galley", "Do file path " + file_path +" "+url);
        ...
        try {
            ...
            Log.d("galley", "Do file path satish4111" + file_path +" "+url);

            try {

                Log.d("galley", "Do file path satish5111" + file_path +" "+url);
