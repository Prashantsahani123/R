 ...
 */
public class ServiceUpdateService extends IntentService {
    public static final String ACTION_DIRECTORY_SYNC = "com.touchbase.DirectorSync.Service",
            ACTION_DIRECTORY_SYNC_COMPLETED = "com.touchbase.DirectorySyncCompleted.Service",
