...
public class DistrictClubActivity extends Activity {
    ...
    public void getClubsList() {
        ...
        if (InternetConnection.checkConnection(this)) {
            ...
            try {
                ...
                Log.e("sa","satish paramters groupId=>"+groupId);
                ...
                try {
                    ...
                    Utils.log("request for get clubs:"+ Constant.DT_GET_CLUBS+" --- " + requestData.toString());
    ...
    public void getResult(String result) {
        ...
        try {
            ...
            Utils.log("Response for clubs:" + result);
