...
//
            ...
            if (uriString.startsWith("content://")) {
                ...
                selectedImagePath = Utils.getPathLocal(uri,Documents_upload.this);//Utils.getPath(getApplicationContext(), uri);
                ...
                File cacheDir = Utils.getDocumentCacheDir(Documents_upload.this);
                ...
                if (myFile != null) {
                    ...
                    Utils.saveFileFromUri(Documents_upload.this, uri, destinationPath);
                }
...
//                    uploadedpdfid = Utils.doPdfFileUpload(new File(selectedImagePath), "ebulletin"); // Upload File to server
                    ...
                    uploadedpdfid = Utils.doPdfFileUpload(myFile, "ebulletin"); // Upload File to server
