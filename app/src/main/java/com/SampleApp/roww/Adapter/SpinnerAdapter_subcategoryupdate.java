...
public class SpinnerAdapter_subcategoryupdate extends BaseAdapter implements Filterable {

    LayoutInflater inflator;
    ArrayList<AlbumData> list;

    public SpinnerAdapter_subcategoryupdate(Context context, ArrayList<AlbumData> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AlbumData data = list.get(position);
            ...
            tv.setText(data.getSubcategoryNameupdate());
            tv.setTag(data);
