...
import com.SampleApp.row.NotificationDataBase.DatabaseHelper;
...
import static com.SampleApp.row.Utils.PreferenceManager.isRIadminModule;
...
public class E_BulletineAdapter extends ArrayAdapter<E_BulletineListData> {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            public void onClick(View v) {
                ...
                if (item.getEbulletinType().equals("Link")) {
                    ...
                    if (url != null && !url.isEmpty()) {
                        ...
                        //    browserIntent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_TASK_ON_HOME);
                    ...
                    if (link != null && !link.isEmpty()) {
                        ...
                        //This code is commented By Gaurav for close background download
        ...
        //Added By Gaurav for comes from Rotary India module for view data
        if (PreferenceManager.getPreference(mContext, isRIadminModule).equals("Yes")) {
            holder.iv_delete.setVisibility(View.GONE);
        }
                ...
                tv_yes.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (InternetConnection.checkConnection(mContext)) {
                            ...
                            DatabaseHelper databaseHelpers = new DatabaseHelper(mContext);
                            //Delete Data into Database
                            Integer notificationDelete = databaseHelpers.deleteDataBaseOnEventId(item.getEbulletinID());

                            if (notificationDelete == 1) {

                                Log.d("PARAMETERS", "Notification Data Deleted from NewsLetterList successfully");
