...
public class SpinnerAdapter_subtosubcategoryupdate extends BaseAdapter implements Filterable{

    LayoutInflater inflator;
    ArrayList<AlbumData> list;

    public SpinnerAdapter_subtosubcategoryupdate(Context context, ArrayList<AlbumData> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        AlbumData data=list.get(position);
            ...
            tv.setText(data.getSubtosubcategorynameupdate());
            tv.setTag(data);
