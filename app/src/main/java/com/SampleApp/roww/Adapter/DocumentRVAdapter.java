...
public class DocumentRVAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void bindDocumentViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        if (isAdmin.equals("No")) {  // 1 means user is Admin
            ...
            //Added By Gaurav for Rotary India module data only view
        ...
        if (data.getAccessType().equals("0")) {  // access type view
            ...
            docHolder.getIvView().setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    //  viewDocument(data);
                    //added By Gaurav
                    /*   this is for share the file*/
                    downloadDocumentShare(data);
    ...
    public void downloadDocumentShare(DocumentListData data) {
        ...
        tv_yes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (InternetConnection.checkConnection(context)) {
                    ...
                    dialog.dismiss();
                    //This code is added by Gaurav for Delete data from Notification List base on event id
                    DatabaseHelper databaseHelpers = new DatabaseHelper(context);
                    //Delete Data into Database
                    Integer notificationDelete = databaseHelpers.deleteDataBaseOnEventId(data.getDocID());
