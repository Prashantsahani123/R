...
public class ClubGalleryAdapter_New extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    Context context;
    ...
    public ClubGalleryAdapter_New(Context context, ArrayList<ClubGalleryData> list){
    ...
    public void bindEmptyView(RecyclerView.ViewHolder holder, final int position) {
         ((EmptyViewHolder) holder).getEmptyView().setText(" ");//blank list display
    }
