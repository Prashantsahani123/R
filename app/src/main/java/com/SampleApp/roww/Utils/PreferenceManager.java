...
public class PreferenceManager {
    ...
    public static final String GROUP_ACTIVE_FLAG = "groupActiveFlag_";
    public static final String REQUESTED = "requested_";
    public static final String eventList="eventList";
    public static final String Isrotaryindiaadminmodule="Yes";
    public static final String isRIadminModule="No";
