...
public class Constant {
  ...
  public final static String TEST_URL = "http://rowtestapi.rosteronwheels.com";
    ...
    //ROW New live server url
   //  public final static String LIVE_URL = "http://apitest.rotary-india.org";//New Live serever



    // TEST_URL
    public final static String BaseURL_V3 = LIVE_URL + "/V4/api/"; // test environment;  ///          http://rowtestapi.rosteronwheels.com/V4/api/Group/GetAllGroupsList
   // public final static String BaseURL_V3 = LIVE_URL + "/V4/api/"; // live environment

    // public final static String BaseURL_V3 = TEST_URL + "/V4/api/"; // test environment

    // added by prashant sahani
    //com/V4/api/Gallery/GetSubProjectOfOngoing


  public static final String sponsordetail = BaseURL_V3 + "Member/GetSponsorReferredDetails?";

    public static final String ongoingproject = BaseURL_V3 + "Gallery/LoadExistingProject";
    public static final String ongproject_detail = BaseURL_V3 + "Gallery/GetSubProjectOfOngoing";
...
//    public final static String BaseURL_V3 = "http://rowtestapi.touchbase.in/V1/api";
    ...
    /*  New Device Token update  API added by Gaurav on 19th Nov 2020*/
    public final static String UpdateDeviceTokenNumber = BaseURL_V3 + "Group/UpdateDeviceTokenNumber";
    /////////////////////////////////////////////////////////////////////////////


    public final static String UserLogin = BaseURL_V3 + "Login/UserLogin";         //  http://rowapi.rosteronwheels.com/V4/api/Login/UserLogin
    public final static String PostOTP = BaseURL_V3 + "Login/PostOTP";
    public final static String GetWelcomeScreen = BaseURL_V3 + "Login/GetWelcomeScreen";//  http://rowapi.rosteronwheels.com/V4/api/Login/GetWelcomeScreen
    ...
    public final static String RotaryIndiaGetEventList = BaseURL_V3 + "Event/RotaryIndiaGetEventList";
    public final static String GetAnnouncementList = BaseURL_V3 + "Announcement/GetAnnouncementList";
    public final static String RotaryIndiaAnnouncementlist = BaseURL_V3 + "Announcement/RotaryIndiaAnnouncementlist";
    ...
    public final static String GetSMSCountDetail = BaseURL_V3 + "Event/Getsmscountdetails";
    ...
    public final static String RotaryIndiaNewsletterlist = BaseURL_V3 + "Ebulletin/RotaryIndiaNewsletterlist";
    ...
    public final static String RotaryIndiaGetDocumentList = BaseURL_V3 + "DocumentSafe/RotaryIndiaGetDocumentList";
    ...
    //Added By Gaurav for Rotary Admin
    public final static String GetRotaryIndiaAdminModules = BaseURL_V3 + "Group/GetRotaryIndiaAdminModules";
    ...
    public final static String GetMemberListSync = BaseURL_V3 + "Member/GetMemberListSync";          ///http://rowtestapi.rosteronwheels.com/V4/api/Member/GetMemberListSync
                                                                                                     //  http://rowtestapi.rosteronwheels.com/V4/api/Member/UpdateProfileDetails
    ...
    public static final int GROUP_CATEGORY_ADMIN = 0, GROUP_CATEGORY_CLUB = 1, GROUP_CATEGORY_DT = 2, GROUP_CATEGORY_EVENT = 3;
    ...
    //Gallery/projectmove
    public final static String Getprojectmove_or_delete = BaseURL_V3 + "Gallery/projectmove";
    ...
    //Added By Gaurav
    public final static String GetValidateDirectBeneficiaries = BaseURL_V3 + "Gallery/validateDirectBeneficiaries";
    public final static String SendMailBeneficiaries = BaseURL_V3 + "Gallery/SendMailBeneficiaries";
    //closed By GauravGetGroupModulesList
    ...
    public static final String GetNotificationlist = BaseURL_V3 + "Gallery/GetNotificationlist";
    public static final String GetSharedTransactionData = BaseURL_V3 + "Group/Get_SharedTransactionData";
    public static final String SendSMSAndMailToNonSubmitedReports = BaseURL_V3 + "ClubMonthlyReport/SendSMSAndMailToNonSubmitedReports";

    public static final String GetZonelist = BaseURL_V3 + "Group/getZonelist";

    public static final String GetAdminModulelist = BaseURL_V3 + "Group/getAdminSubModules";

    //===================== Dashboard Popup for Ad ===========================
    //Add By Nivedita
    public static final String GetMobilePupup = BaseURL_V3 + "Group/getMobilePupup";
    public static final String UpdateMobilePupupFlag = BaseURL_V3 + "Group/UpdateMobilePupupflag";
}
