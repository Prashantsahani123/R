...
public class ROWHelpline extends AppCompatActivity {
    ...
    TextView tv_mobile,tv_mobile1,tv_phone,tv_email,tv_website, tv_title;
    ...
    private void actionbarfunction() {
        ...
        tv_title.setText("Rotary India Helpline");
    }
    private void init() {
       ...
       // tv_phone = (TextView) findViewById(R.id.tv_Phone);
        ...
        tv_mobile1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Intent.ACTION_DIAL, Uri.fromParts("tel", tv_mobile1.getText().toString(), null));
                startActivity(intent);
            }
        });
...
*/
        ...
        tv_website.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("modulename","Rotary India Website");
