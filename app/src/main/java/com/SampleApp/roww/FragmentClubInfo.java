...
public class FragmentClubInfo extends Fragment {
    ...
    private void loadData(){
        ...
        if ( !isInfoLoaded ) {
            ...
            Utils.log("My Extras ClubInfo: " + extras);
            ...
            if (status.equalsIgnoreCase("0")) {
                ...
                if (count_president > 0) {
                    for (int i = 0; i < count_president; i++) {
                        ...
                        ImageView iv_whatsapp = (ImageView) view_clubDetails.findViewById(R.id.iv_whatsapp);
                        ...
                        iv_whatsapp.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view) {
                                if(Utils.appInstalledOrNot(context)){
                                    ...
                                    String url = "https://api.whatsapp.com/send?phone="+mobileNumber;//"https://wa.me/"+profileData.getMobile()+"/?text=hii";
