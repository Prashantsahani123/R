...
public class ProfileModel {
    ...
    public ArrayList<ProfileMasterData> getMembers(long groupId) {
        ...
        try {
            ...
            // this for include duplicate rows.
         //   Cursor cur = db.rawQuery("select * from "+Tables.ProfileMaster.TABLE_NAME+" where "+Tables.ProfileMaster.Columns.GROUP_ID+"="+groupId+" order by LOWER("+Tables.ProfileMaster.Columns.MEMBER_NAME+")", null);

            //this for exclude duplicate rows.
            Cursor cur = db.rawQuery("select * from "+Tables.ProfileMaster.TABLE_NAME+" where "+Tables.ProfileMaster.Columns.GROUP_ID+"="+groupId+" GROUP BY "+Tables.ProfileMaster.Columns.PROFILE_ID+" order by LOWER("+Tables.ProfileMaster.Columns.MEMBER_NAME+")", null);
    ...
    public ArrayList<ProfileMasterData> search(long groupId, String keyword) {
        ...
        try {
            ...
            Cursor cur = db.rawQuery("select * from "+Tables.ProfileMaster.TABLE_NAME+" " +
                    "where "+Tables.ProfileMaster.Columns.GROUP_ID+"="+groupId+
                    " and ("+Tables.ProfileMaster.Columns.MEMBER_NAME+" like '"+keyword+
                    "' or "+Tables.ProfileMaster.Columns.MEMBER_MOBILE+" like '"+keyword+"') GROUP BY "+Tables.ProfileMaster.Columns.PROFILE_ID+ " order by LOWER("+
                    Tables.ProfileMaster.Columns.MEMBER_NAME+") COLLATE NOCASE ASC", null);
    ...
    public ArrayList<FamilywiseMemberData> getFamilyWiseMemberSerach(long groupId, String keyword) {
...
//            db.execSQL("delete from "+Tables.FamilyMemberDetail.TABLE_NAME+" where "+Tables.FamilyMemberDetail.Columns.PROFILE_ID+" in "+profileIds);
    ...
    public boolean deleteDirectory(long grpId) {

        try {

            Cursor cursor = db.rawQuery("select profileId from "+Tables.ProfileMaster.TABLE_NAME+" where "+ Tables.ProfileMaster.Columns.GROUP_ID+"="+grpId, null);

            while(cursor.moveToNext()){

                int profileId = cursor.getInt(0);

                db.delete(Tables.AddressDetails.TABLE_NAME,Tables.ProfileMaster.Columns.PROFILE_ID+"="+profileId,null);
                db.delete(Tables.BusinessMemberDetails.TABLE_NAME,Tables.ProfileMaster.Columns.PROFILE_ID+"="+profileId,null);
                db.delete(Tables.FamilyMemberDetail.TABLE_NAME,Tables.ProfileMaster.Columns.PROFILE_ID+"="+profileId,null);
                db.delete(Tables.PersonalMemberDetails.TABLE_NAME,Tables.ProfileMaster.Columns.PROFILE_ID+"="+profileId,null);
                db.delete(com.SampleApp.row.sql.Tables.ProfileMaster.TABLE_NAME,Tables.ProfileMaster.Columns.PROFILE_ID+"="+profileId,null);
            }
