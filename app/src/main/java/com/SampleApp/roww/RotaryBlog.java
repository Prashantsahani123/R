...
//                Log.d("row","blog ="+tagName+" type="+eventType);

                switch (eventType) {

                    case XmlPullParser.START_TAG:

                        //Log.d("row blog","start "+tagName);
                    ...
                    case XmlPullParser.TEXT:
                        text = parser.getText();
                        //Log.d("row blog","text "+tagName+" "+text);
                        break;

                    case XmlPullParser.END_TAG:

                        //Log.d("row blog","end "+tagName);
                        ...
                        if (tagName.equals("item")) {
                           ...
                           // Log.d("row","blog ="+ctr+" preTag="+prevTag+" currTag="+tagName);
